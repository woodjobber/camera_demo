...
/// each other.
///
/// Controllers are added and returned via [obs]. The initial offset
...
class SyncScrollControllerGroup {
  ...
  _SyncScrollControllerGroupOffsetNotifier _offsetNotifier;
  ...
  void destroy() {
    for (var value in _allControllers) {
      value.removeListener(_offsetNotifier.notifyListeners);
      value.dispose();
    }
    while (_allControllers.isNotEmpty) {
      _allControllers.removeLast();
    }
  }
