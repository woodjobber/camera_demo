...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  Future<img.Image> fixImage(NativeDeviceOrientation orientation) async {
    ...
    print(angle);
    img.Image orientedImage = img.copyRotate(capturedImage, angle);
    final directory = await getApplicationDocumentsDirectory();
    String path = directory.path + '/${imageFile.name}';
    final mimeType = imageFile.mimeType;
    final name = imageFile.name;
    final lastModified = await imageFile.lastModified();
    final length = await imageFile.length();
    final bytes = img.encodeJpg(orientedImage);
  ...
  double get videoPreviewAspectRatio {
    int rotationQuarterTurns = convertOrientationToQuarterTurns(orientation);
    ...
    bool isDeviceInLandscape =
        rotationQuarterTurns == 1 || rotationQuarterTurns == 3;
    print(isDeviceInLandscape);
